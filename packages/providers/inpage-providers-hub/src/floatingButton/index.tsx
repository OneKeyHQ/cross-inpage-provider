...
const SECURITY_INFO: Record<Exclude<EHostSecurityLevel, EHostSecurityLevel.Unknown>, { titleId: string; icon: any }> = {
  [EHostSecurityLevel.Security]: {
    titleId: 'verifiedSite',
    icon: <VerifiedIcon style={{ width: 16, height: 16 }} />,
  },
